...
class DataGridComponent extends Component {
    ...
    render() { 
        ...
        return (
        <table className="table table-bordered table-dark" style={{display: this.state.displayTable}}>
                    <thead>
                        <tr>
                            <th><div className="custom-control custom-checkbox"><button className="btn btn-danger" onClick={this.deleteSelectedSt.bind(this)}>Delete Selected</button><br/><input type="checkbox" onChange={this.mainCheckBox.bind(this)} checked={this.state.maincheckbox}/></div></th>
